...
public class OrderItemController {
	@RequestMapping("/save")
	public void save(@RequestParam("id") Integer id,@RequestParam("orderNo") Integer orderNo,@RequestParam("itemId") Integer itemId,@RequestParam("qty")Integer qty,@RequestParam("orderItemPrice")Integer orderItemPrice,@RequestParam("paymentStatus") String paymentStatus) {
